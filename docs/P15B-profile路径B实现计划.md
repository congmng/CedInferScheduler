...
| 层类型 | RTX4090 | RTX5090 | A100 | p10 | p90 |
|---|---:|---:|---:|---:|---:|
| r0（无状态分支，对照） | **1.000** | **1.000** | **1.001** | 0.998 | 1.003 |
| r4（CSA，top-k 最多 4096 状态） | **2.069** | **2.068** | **2.174** | 1.27 | 3.26 |
| r128（HCA） | **1.486** | **1.525** | **1.533** | 1.00 | 1.81 |

三张架构（sm89 / sm120 / sm80）上的比值几乎一模一样——**说明这不是某张卡的
编译/调优问题，而是 kernel 结构本身**。
